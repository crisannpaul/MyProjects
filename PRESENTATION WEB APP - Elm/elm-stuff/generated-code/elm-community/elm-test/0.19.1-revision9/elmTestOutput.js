...
var $author$project$Model$Date$month = function (_v0) {
	var d = _v0.a;
	return d.month;
};
var $author$project$Model$Date$year = function (_v0) {
	var d = _v0.a;
	return d.year;
};
var $author$project$Model$Date$monthsInDate = function (date) {
	var y = $author$project$Model$Date$year(date);
	var m = $author$project$Model$Date$month(date);
	if (m.$ === 'Just') {
		var mo = m.a;
		return (y * 12) + $author$project$Model$Date$monthToInt(mo);
	} else {
		return y * 12;
	}
};
var $author$project$Model$Date$compare = F2(
	function (_v0, _v1) {
		var d1 = _v0.a;
		var d2 = _v1.a;
		var x2 = $author$project$Model$Date$monthsInDate(
			$author$project$Model$Date$Date(d2));
		var x1 = $author$project$Model$Date$monthsInDate(
			$author$project$Model$Date$Date(d1));
		return (_Utils_cmp(x1, x2) > 0) ? $elm$core$Basics$GT : ((_Utils_cmp(x1, x2) < 0) ? $elm$core$Basics$LT : $elm$core$Basics$EQ);
	});
...
var $author$project$Model$Date$monthsBetween = F2(
	function (dA, dB) {
		var yearB = $author$project$Model$Date$year(dB);
		var yearA = $author$project$Model$Date$year(dA);
		var monthB = $author$project$Model$Date$month(dB);
		var monthA = $author$project$Model$Date$month(dA);
		var _v0 = _Utils_Tuple2(monthA, monthB);
		_v0$2:
		while (true) {
			if (_v0.a.$ === 'Just') {
				if (_v0.b.$ === 'Just') {
					...
					return $elm$core$Maybe$Just(
						$elm$core$Basics$abs(
							($author$project$Model$Date$monthToInt(b) + (yearB * 12)) - ($author$project$Model$Date$monthToInt(a) + (yearA * 12))));
				} else {
					break _v0$2;
				}
			} else {
				if (_v0.b.$ === 'Nothing') {
					var _v1 = _v0.a;
					var _v2 = _v0.b;
					return $elm$core$Maybe$Just(12 * (yearB - yearA));
				} else {
					break _v0$2;
				}
			}
...
var $author$project$Model$Date$monthsBetweenMonths = F2(
	function (m1, m2) {
		return $elm$core$Basics$abs(
			$author$project$Model$Date$monthToInt(m2) - $author$project$Model$Date$monthToInt(m1));
	});
...
var $author$project$Model$Event$Category$allSelected = _List_fromArray(
	[
		_Utils_Tuple2($author$project$Model$Event$Category$Academic, true),
		_Utils_Tuple2($author$project$Model$Event$Category$Work, true),
		_Utils_Tuple2($author$project$Model$Event$Category$Project, true),
		_Utils_Tuple2($author$project$Model$Event$Category$Award, true)
	]);
...
var $author$project$Model$Event$Category$set = F3(
	function (category, value, current) {
		var setHelp = F3(
			function (curr, cat, val) {
				var _v0 = _Utils_Tuple2(curr.a, cat);
				_v0$4:
				while (true) {
					switch (_v0.a.$) {
						case 'Academic':
		...
		return A2(
			$elm$core$List$map,
			function (x) {
				return A3(setHelp, x, category, value);
			},
			current);
	});
...
var $author$project$Model$Interval$compare = F2(
	function (_v0, _v1) {
		var intA = _v0.a;
		var intB = _v1.a;
		var startB = intB.start;
		var startA = intA.start;
		var endB = intB.end;
		var endA = intA.end;
		var _v2 = A2($author$project$Model$Date$compare, startA, startB);
		switch (_v2.$) {
			case 'LT':
			...
			default:
				var _v3 = _Utils_Tuple2(endA, endB);
				if (_v3.a.$ === 'Just') {
					if (_v3.b.$ === 'Just') {
						var a = _v3.a.a;
						var b = _v3.b.a;
						return A2($author$project$Model$Date$compare, a, b);
					} else {
						var _v4 = _v3.b;
						return $elm$core$Basics$LT;
					}
...
var $author$project$Model$Date$view = function (_v0) {
	var d = _v0.a;
	var y = $author$project$Model$Date$year(
		$author$project$Model$Date$Date(d));
	var m = $author$project$Model$Date$month(
		$author$project$Model$Date$Date(d));
	if (m.$ === 'Just') {
		var mo = m.a;
		return $elm$html$Html$text(
			$author$project$Model$Date$monthToString(mo) + (' ' + $elm$core$String$fromInt(y)));
	} else {
		return $elm$html$Html$text(
...
var $author$project$Model$personalDetails = {
	contacts: _List_fromArray(
		[
			A2($author$project$Model$PersonalDetails$DetailWithName, 'Email', 'paulteodorcrisan@gmail.com')
		]),
	intro: 'I like martial arts, lifting, running, making music and also Elm',
	name: 'Crisan Paul',
	socials: _List_fromArray(
		[
			A2($author$project$Model$PersonalDetails$DetailWithName, 'My Github', 'https://github.com/crisannpaul')
		])
};
...
var $NoRedInk$elm_compare$Compare$compose = F4(
	function (fn, comparator, left, right) {
		return A2(
			comparator,
			fn(left),
			fn(right));
	});
var $NoRedInk$elm_compare$Compare$reverse = F3(
	function (comparator, a, b) {
		return A2(comparator, b, a);
	});
var $elm$core$List$sortWith = _List_sortWith;
var $author$project$Model$Event$sortByInterval = function (events) {
	var eventComparator = $NoRedInk$elm_compare$Compare$reverse(
		A2(
			$NoRedInk$elm_compare$Compare$compose,
			function ($) {
				return $.interval;
			},
			$author$project$Model$Interval$compare));
	return A2($elm$core$List$sortWith, eventComparator, events);
};
...
var $author$project$Main$getRepos = $elm$http$Http$get(
	{
		expect: A2(
			$elm$http$Http$expectJson,
			$author$project$Main$GotRepos,
			$elm$json$Json$Decode$list($author$project$Model$Repo$decodeRepo)),
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'GetRepos':
				return _Utils_Tuple2(model, $author$project$Main$getRepos);
			case 'GotRepos':
				var res = msg.a;
				if (res.$ === 'Ok') {
					var result = res.a;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				'Academic',
				A2($author$project$Model$Event$Category$isEventCategorySelected, $author$project$Model$Event$Category$Academic, model),
				$author$project$Model$Event$Category$Academic),
				A3(
				$author$project$Model$Event$Category$checkbox,
				'Work',
				A2($author$project$Model$Event$Category$isEventCategorySelected, $author$project$Model$Event$Category$Work, model),
				$author$project$Model$Event$Category$Work),
				A3(
				$author$project$Model$Event$Category$checkbox,
				'Project',
				A2($author$project$Model$Event$Category$isEventCategorySelected, $author$project$Model$Event$Category$Project, model),
				$author$project$Model$Event$Category$Project),
				A3(
				$author$project$Model$Event$Category$checkbox,
				'Award',
				A2($author$project$Model$Event$Category$isEventCategorySelected, $author$project$Model$Event$Category$Award, model),
				$author$project$Model$Event$Category$Award)
			]));
};
...
var $author$project$Model$Event$Category$eventCategoryToString = function (eventCategory) {
...
var $author$project$Model$Interval$view = function (interval) {
	var start = function (_v5) {
		var _int = _v5.a;
		return $author$project$Model$Date$view(_int.start);
	};
	var end = function (_v4) {
		var _int = _v4.a;
		var _v3 = _int.end;
		if (_v3.$ === 'Just') {
			var date = _v3.a;
			return $author$project$Model$Date$view(date);
		} else {
			return $elm$html$Html$text('Present');
		}
	};
	var duration = function (_v2) {
		var _int = _v2.a;
		var _v0 = $author$project$Model$Interval$length(
			$author$project$Model$Interval$Interval(_int));
		if (_v0.$ === 'Just') {
			var _v1 = _v0.a;
			var years = _v1.a;
			var months = _v1.b;
			return $elm$html$Html$text(
				$elm$core$String$fromInt(years) + (' years and ' + ($elm$core$String$fromInt(months) + ' months')));
		} else {
			return $elm$html$Html$text('Undefined');
		}
	};
	return A2(
		$elm$html$Html$div,
...
var $author$project$Model$Event$view = function (event) {
	var eventClass = function (ev) {
		return ev.important ? 'event event-important' : 'event';
	};
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								$author$project$Model$Event$Category$eventCategoryToString(event.category))
							])),
						A2(
						$elm$html$Html$li,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								A2($elm$core$Maybe$withDefault, 'No event url', event.url))
							]))
					]))
			]));
};
...
var $author$project$Model$PersonalDetails$toSimpleLi = function (d) {
	return A2(
		$elm$html$Html$li,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$text(': '),
				$elm$html$Html$text(d.detail)
			]));
};
var $author$project$Model$PersonalDetails$toHtmlList = function (details) {
	return A2(
		$elm$html$Html$ul,
		_List_Nil,
		A2($elm$core$List$map, $author$project$Model$PersonalDetails$toSimpleLi, details));
};
...
var $author$project$Model$PersonalDetails$toRefLi = function (d) {
	return A2(
		$elm$html$Html$li,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$href(d.detail)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(d.name)
...
var $author$project$Model$PersonalDetails$toHtmlRefList = function (details) {
	return A2(
		$elm$html$Html$ul,
		_List_Nil,
		A2($elm$core$List$map, $author$project$Model$PersonalDetails$toRefLi, details));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Contacts: ')
					])),
				$author$project$Model$PersonalDetails$toHtmlList(details.contacts),
				A2(
				$elm$html$Html$h3,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('Socials: ')
					])),
				$author$project$Model$PersonalDetails$toHtmlRefList(details.socials)
			]));
};
...
var $NoRedInk$elm_compare$Compare$by = F3(
	function (fn, a, b) {
		return A2(
...
var $author$project$Model$Repo$sortByStars = function (repos) {
	var starsComparator = $NoRedInk$elm_compare$Compare$by(
		function ($) {
			return $.stars;
		});
	return $elm$core$List$reverse(
		A2($elm$core$List$sortWith, starsComparator, repos));
};
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						A2($elm$core$Maybe$withDefault, 'No desctiprion', repo.description))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Link to repository')
							]))
					])),
				A2(
				$elm$html$Html$p,
...
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['/home/daddy/Desktop/PF/proiect/Elm-Project/tests/DateTests.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/EventCategoryTests.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/EventTests.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/Example.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/IntervalTests.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/PersonalDetailsTests.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/RepoTests.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Date/Compare0.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Date/Compare1.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Date/Compare2.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Date/Compare3.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Date/Compare4.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Date/Compare5.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Date/MonthsBetween0.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Date/MonthsBetween1.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Date/MonthsBetween2.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Date/MonthsBetween3.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Date/MonthsBetween4.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Date/MonthsBetween5.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Date/MonthsBetween6.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Date/MonthsBetween7.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Date/MonthsBetween8.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Date/MonthsBetween9.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Date/MonthsBetweenMonths0.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Date/MonthsBetweenMonths1.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Date/MonthsBetweenMonths2.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Event/Category/AllSelected0.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Event/Category/IsEventCategorySelected0.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Event/Category/Set0.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Event/Category/Set1.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Interval/Compare0.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Interval/Compare1.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Interval/Compare2.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Interval/Compare3.elm', '/home/daddy/Desktop/PF/proiect/Elm-Project/tests/VerifyExamples/Model/Interval/Compare4.elm']),
		processes: 2,
...
var pipeFilename = "/tmp/elm_test-4453.sock";
var net = require('net'),
