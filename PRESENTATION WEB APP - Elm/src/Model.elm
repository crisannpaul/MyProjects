...
personalDetails =
    { name = "Crisan Paul"
    , intro = "Billionare | Playboy | Genius | Philantropist | Martial Artist | 180 kg Deadlift"
    , contacts = [ DetailWithName "Email" "paulteodorcrisan@gmail.com" ]
    , socials = [ DetailWithName "My Github" "https://github.com/crisannpaul" ]
    }
