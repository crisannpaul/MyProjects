...
HD_PWD='C:/Users/Hp/Desktop/PS2 PROTOCOL/PS2 PROTOCOL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log big_thing.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source big_thing.tcl -notrace
