...
HD_PWD='C:/Users/Hp/Desktop/PS2 PROTOCOL/PS2 PROTOCOL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log big_thing.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source big_thing.tcl
