...
var $author$project$Model$WeatherData$toHourlyDataPoints = function (weatherData) {
			...
			return function (y) {
				return function (z) {
					return A3(
						...
						$elm$time$Time$millisToPosix((x + weatherData.utcOffset) * 1000),
						y,
						z);
				};
			};
...
var $author$project$Util$groupBy = F2(
	function (op, list) {
		...
		var addTuples = F2(
			function (list1, tuple) {
				var helper1 = F3(
					function (lst, acc, ok) {
						helper1:
						while (true) {
							if (!lst.b) {
								return ($elm$core$List$isEmpty(acc) || ok) ? $elm$core$List$reverse(
									A2($elm$core$List$cons, tuple, acc)) : $elm$core$List$reverse(acc);
							} else {
								var x = lst.a;
								var xs = lst.b;
								if (_Utils_eq(
				...
				return A3(helper1, list1, _List_Nil, true);
			});
		var helper2 = F2(
			function (lst, acc) {
				helper2:
...
var $author$project$Util$maximumBy = F2(
	function (factor, list) {
		...
		return lastElem(
			A2($elm$core$List$sortBy, factor, list));
	});
...
var $author$project$Util$zipFilter = F2(
	function (listBool, list) {
		var listZip = A3($elm$core$List$map2, $elm$core$Tuple$pair, listBool, list);
		return A2(
			$elm$core$List$map,
...
var $author$project$View$Day$view = function (day) {
	var lowTemp = function (temp) {
		if (temp.$ === 'Just') {
			var t = temp.a;
			return 'Low temperature: ' + $elm$core$String$fromFloat(t);
		} else {
			return 'unavailable';
		}
	};
	var highTemp = function (temp) {
		if (temp.$ === 'Just') {
			var t = temp.a;
			return 'High temperature: ' + $elm$core$String$fromFloat(t);
		} else {
			return 'unavailable';
		}
	};
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Util$Time$formatDate(day.date))
					])),
				A2(
				$elm$html$Html$p,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						'Precipitation: ' + $elm$core$String$fromFloat(day.totalPrecipitaion))
					]))
			]));
};
...
var $author$project$Main$lastElem = function (lst) {
	lastElem:
	while (true) {
		if (!lst.b) {
			return $elm$core$Maybe$Nothing;
...
var $author$project$Main$getChartData = function (weather) {
	var shownItems = $author$project$View$WeatherChart$showAllItems;
	var now = weather.time;
	var hovering = weather.hovering;
	var hourlyPoints = $author$project$Model$WeatherData$toHourlyDataPoints(weather.weather);
	var maxTemp = $author$project$Main$lastElem(
		A2(
			$elm$core$List$sortBy,
			function ($) {
				return $.temperature;
			...
			hourlyPoints));
	var minTemp = $elm$core$List$head(
		A2(
			$elm$core$List$sortBy,
			function ($) {
				return $.temperature;
			...
			hourlyPoints));
	return A6($author$project$View$WeatherChart$ChartData, now, minTemp, maxTemp, hourlyPoints, hovering, shownItems);
};
var $author$project$View$Week$WeeklyData = function (dailyData) {
	return {dailyData: dailyData};
};
var $author$project$Main$getPrecipitation = function (_v0) {
	var precipitation = _v0.precipitation;
	return precipitation;
};
var $author$project$Main$getTemp = function (_v0) {
...
var $author$project$Main$getWeeklyData = function (weath) {
	var weather = weath.weather;
	var toDailydata = F2(
		function (dp, acc) {
			toDailydata:
			while (true) {
				if (dp.b) {
					...
					var tempList = A2(
						$elm$core$List$map,
						function (x1) {
							return $author$project$Main$getTemp(x1);
						},
						function (_v3) {
							var u = _v3.a;
							var v = _v3.b;
					...
					var precList = A2(
						$elm$core$List$map,
						function (x1) {
							return $author$project$Main$getPrecipitation(x1);
						},
						function (_v2) {
							var u = _v2.a;
							var v = _v2.b;
					...
					var totalPrecipitaion = A3($elm$core$List$foldl, $elm$core$Basics$add, 0, precList);
					var lowTemp = $elm$core$List$minimum(tempList);
					var highTemp = $elm$core$List$maximum(tempList);
					var date = function (_v1) {
						var u = _v1.a;
						var v = _v1.b;
						return u;
					}(x);
					var $temp$dp = xs,
						$temp$acc = A2(
						$elm$core$List$cons,
						{date: date, highTemp: highTemp, lowTemp: lowTemp, totalPrecipitaion: totalPrecipitaion},
						acc);
					dp = $temp$dp;
					acc = $temp$acc;
					continue toDailydata;
				} else {
					return $elm$core$List$reverse(acc);
				}
			}
		});
	var offset = weather.utcOffset;
	var hourlyPoints = $author$project$Model$WeatherData$toHourlyDataPoints(weather);
	var dailyPoints = A2(
		$author$project$Util$groupBy,
		function (x) {
			return A2($author$project$Util$Time$posixToDate, $elm$time$Time$utc, x.time);
		},
		hourlyPoints);
	return $author$project$View$Week$WeeklyData(
		A2(toDailydata, dailyPoints, _List_Nil));
};
				...
				switch (_v1.a.$) {
					...
					case 'ChangeWeatherItemSelection':
						if (_v1.b.$ === 'HaveWeatherAndTime') {
							...
							var newValue = _v3.b;
							var data = _v1.b.a;
							var selected = A3($author$project$Model$WeatherItems$set, item, newValue, data.selectedItems);
							return _Utils_Tuple2(
								$author$project$Model$HaveWeatherAndTime(
									_Utils_update(
										data,
	...
	function (msg, model) {
		return A2(
			...
			_List_fromArray(
				[
					A4(
					$author$project$View$WeatherItems$checkbox,
					'Temperature',
					A2($author$project$Model$WeatherItems$isItemSelected, $author$project$Model$WeatherItems$Temperature, model),
					msg.onChangeSelection,
					$author$project$Model$WeatherItems$Temperature),
					A4(
					$author$project$View$WeatherItems$checkbox,
					'Precipitation',
					A2($author$project$Model$WeatherItems$isItemSelected, $author$project$Model$WeatherItems$Precipitation, model),
					msg.onChangeSelection,
					$author$project$Model$WeatherItems$Precipitation),
					A4(
					$author$project$View$WeatherItems$checkbox,
					'MinMax',
					A2($author$project$Model$WeatherItems$isItemSelected, $author$project$Model$WeatherItems$MinMax, model),
					msg.onChangeSelection,
					$author$project$Model$WeatherItems$MinMax),
					A4(
					$author$project$View$WeatherItems$checkbox,
					'CurrentTime',
					A2($author$project$Model$WeatherItems$isItemSelected, $author$project$Model$WeatherItems$CurrentTime, model),
					msg.onChangeSelection,
					$author$project$Model$WeatherItems$CurrentTime)
				]));
	});
var $author$project$View$Week$view = function (weeklyData) {
	var dailyDataHtml = A2($elm$core$List$map, $author$project$View$Day$view, weeklyData.dailyData);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				A2($elm$html$Html$h2, _List_Nil, dailyDataHtml)
			]));
};
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						{onChangeSelection: $author$project$Main$ChangeWeatherItemSelection},
						data.selectedItems),
						A2(
...
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['/home/daddy/Desktop/PF/Proiect Simina/Elm-Project(1)/tests/DayViewTests.elm', '/home/daddy/Desktop/PF/Proiect Simina/Elm-Project(1)/tests/MainTests.elm', '/home/daddy/Desktop/PF/Proiect Simina/Elm-Project(1)/tests/VerifyExamples/Model/WeatherData/ToHourlyDataPoints0.elm', '/home/daddy/Desktop/PF/Proiect Simina/Elm-Project(1)/tests/VerifyExamples/Model/WeatherItems/AllSelected0.elm', '/home/daddy/Desktop/PF/Proiect Simina/Elm-Project(1)/tests/VerifyExamples/Model/WeatherItems/AllSelected1.elm', '/home/daddy/Desktop/PF/Proiect Simina/Elm-Project(1)/tests/VerifyExamples/Model/WeatherItems/IsItemSelected0.elm', '/home/daddy/Desktop/PF/Proiect Simina/Elm-Project(1)/tests/VerifyExamples/Model/WeatherItems/Set0.elm', '/home/daddy/Desktop/PF/Proiect Simina/Elm-Project(1)/tests/VerifyExamples/Model/WeatherItems/Set1.elm', '/home/daddy/Desktop/PF/Proiect Simina/Elm-Project(1)/tests/VerifyExamples/Util/GroupBy0.elm', '/home/daddy/Desktop/PF/Proiect Simina/Elm-Project(1)/tests/VerifyExamples/Util/GroupBy1.elm', '/home/daddy/Desktop/PF/Proiect Simina/Elm-Project(1)/tests/VerifyExamples/Util/GroupBy2.elm', '/home/daddy/Desktop/PF/Proiect Simina/Elm-Project(1)/tests/VerifyExamples/Util/MaximumBy0.elm', '/home/daddy/Desktop/PF/Proiect Simina/Elm-Project(1)/tests/VerifyExamples/Util/MaximumBy1.elm', '/home/daddy/Desktop/PF/Proiect Simina/Elm-Project(1)/tests/VerifyExamples/Util/MaximumBy2.elm', '/home/daddy/Desktop/PF/Proiect Simina/Elm-Project(1)/tests/VerifyExamples/Util/MaybeToList0.elm', '/home/daddy/Desktop/PF/Proiect Simina/Elm-Project(1)/tests/VerifyExamples/Util/MaybeToList1.elm', '/home/daddy/Desktop/PF/Proiect Simina/Elm-Project(1)/tests/VerifyExamples/Util/MinimumBy0.elm', '/home/daddy/Desktop/PF/Proiect Simina/Elm-Project(1)/tests/VerifyExamples/Util/MinimumBy1.elm', '/home/daddy/Desktop/PF/Proiect Simina/Elm-Project(1)/tests/VerifyExamples/Util/MinimumBy2.elm', '/home/daddy/Desktop/PF/Proiect Simina/Elm-Project(1)/tests/VerifyExamples/Util/ZipFilter0.elm', '/home/daddy/Desktop/PF/Proiect Simina/Elm-Project(1)/tests/VerifyExamples/Util/ZipFilter1.elm', '/home/daddy/Desktop/PF/Proiect Simina/Elm-Project(1)/tests/VerifyExamples/Util/ZipFilter2.elm', '/home/daddy/Desktop/PF/Proiect Simina/Elm-Project(1)/tests/WeatherDataTests.elm', '/home/daddy/Desktop/PF/Proiect Simina/Elm-Project(1)/tests/WeatherItemsViewTests.elm', '/home/daddy/Desktop/PF/Proiect Simina/Elm-Project(1)/tests/WeekViewTests.elm']),
		processes: 2,
...
var pipeFilename = "/tmp/elm_test-5832.sock";
var net = require('net'),
