...
HD_PWD='C:/Users/pault/Desktop/semI/SSC/Microblaze/Microblaze.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Microblaze_Block_Design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Microblaze_Block_Design_wrapper.tcl -notrace
