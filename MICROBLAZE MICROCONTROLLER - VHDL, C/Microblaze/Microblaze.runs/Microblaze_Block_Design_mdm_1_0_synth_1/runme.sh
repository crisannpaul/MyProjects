...
HD_PWD='C:/Users/pault/Desktop/semI/SSC/Microblaze/Microblaze.runs/Microblaze_Block_Design_mdm_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Microblaze_Block_Design_mdm_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Microblaze_Block_Design_mdm_1_0.tcl
