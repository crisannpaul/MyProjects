module Entry.DB (LoadDBError (..), SaveError (..), SnippetDB, empty, load, save, modify, findFirst, findAll, size, insertWith, serialize, fromEntries) where
